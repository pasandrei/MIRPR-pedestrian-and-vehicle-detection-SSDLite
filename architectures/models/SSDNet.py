...
class SSD_Head(nn.Module):
    def __init__(self, n_classes, k_20=12, k_10=20, k_5=30, k_3=40, k_2=40, k_1=50, width_mult=1):
        super().__init__()
        ...
        self.out0 = OutConv(int(576 * width_mult), n_classes, k_20)
