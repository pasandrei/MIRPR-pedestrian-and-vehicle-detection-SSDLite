...
| **LR schedule** | Step decay ×0.1 at epochs 42, 55 | — | Constant (staircase decay never triggers: decay_steps=800720 > num_steps=200000) |
...
| **LR schedule** | Step decay ×0.1 at epochs 42, 55 | Exponential decay (0.95/800720 steps — effectively constant LR) | No |
